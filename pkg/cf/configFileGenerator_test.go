...
func TestConfigFileGeneratorBeginArray(t *testing.T) {
	...
	cases := []struct {
		...
		{"yaml", []*map[string]interface{}{doc1}, &SSConfig{Databases: []Database{{D_name: "DB", Collection: Collection{C_name: "Coll", Fields: []Field{{F_name: "name", Constraints: []Constraint{{Item: Item{Type: Type{Type: Array, P_ElementType: []interface{}{Item{Type: Type{Type: String}}}}}}}}}}}}}},
		{"yaml", []*map[string]interface{}{doc2}, &SSConfig{Databases: []Database{{D_name: "DB", Collection: Collection{C_name: "Coll", Fields: []Field{{F_name: "name", Constraints: []Constraint{{Item: Item{Type: Type{Type: Array, P_ElementType: []interface{}{Item{Type: Type{Type: String}}}}}}}}}}}}}},
		{"yaml", []*map[string]interface{}{doc3}, &SSConfig{Databases: []Database{{D_name: "DB", Collection: Collection{C_name: "Coll", Fields: []Field{{F_name: "name", Constraints: []Constraint{{Item: Item{Type: Type{Type: Array, P_ElementType: []interface{}{Item{Type: Type{Type: Double}}}}}}}}}}}}}},
		{"yaml", []*map[string]interface{}{doc1, doc2}, &SSConfig{Databases: []Database{{D_name: "DB", Collection: Collection{C_name: "Coll", Fields: []Field{{F_name: "name", Constraints: []Constraint{{Item: Item{Type: Type{Type: Array, P_ElementType: []interface{}{Item{Type: Type{Type: String}}}}}}}}}}}}}},
		{"yaml", []*map[string]interface{}{doc1, doc3}, &SSConfig{Databases: []Database{{D_name: "DB", Collection: Collection{C_name: "Coll", Fields: []Field{{F_name: "name", Constraints: []Constraint{{Item: Item{Type: Type{Type: Array, P_ElementType: []interface{}{Item{Type: Type{Type: String}}}}}}, {Item: Item{Type: Type{Type: Array, P_ElementType: []interface{}{Item{Type: Type{Type: Double}}}}}}}}}}}}}},
		{"yaml", []*map[string]interface{}{doc2, doc3}, &SSConfig{Databases: []Database{{D_name: "DB", Collection: Collection{C_name: "Coll", Fields: []Field{{F_name: "name", Constraints: []Constraint{{Item: Item{Type: Type{Type: Array, P_ElementType: []interface{}{Item{Type: Type{Type: String}}}}}}, {Item: Item{Type: Type{Type: Array, P_ElementType: []interface{}{Item{Type: Type{Type: Double}}}}}}}}}}}}}},

		{"yaml", []*map[string]interface{}{doc4}, &SSConfig{Databases: []Database{{D_name: "DB", Collection: Collection{C_name: "Coll", Fields: []Field{{F_name: "name", Constraints: []Constraint{{Item: Item{Type: Type{Type: Array, P_ElementType: []interface{}{Item{Type: Type{Type: String}}, Item{Type: Type{Type: Integer}}, Item{Type: Type{Type: Boolean}}}}}}}}}}}}}},
		{"yaml", []*map[string]interface{}{doc1, doc4}, &SSConfig{Databases: []Database{{D_name: "DB", Collection: Collection{C_name: "Coll", Fields: []Field{{F_name: "name", Constraints: []Constraint{{Item: Item{Type: Type{Type: Array, P_ElementType: []interface{}{Item{Type: Type{Type: String}}}}}}, {Item: Item{Type: Type{Type: Array, P_ElementType: []interface{}{Item{Type: Type{Type: String}}, Item{Type: Type{Type: Integer}}, Item{Type: Type{Type: Boolean}}}}}}}}}}}}}},
	}
...
func TestConfigFileGeneratorBeginObject(t *testing.T) {
	...
	cases := []struct {
		...
		{"yaml", []*map[string]interface{}{doc1}, &SSConfig{Databases: []Database{{D_name: "DB", Collection: Collection{C_name: "Coll", Fields: []Field{{F_name: "name", Constraints: []Constraint{{Item: Item{Type: Type{Type: Object, P_ElementType: []interface{}{Field{F_name: "fname", Constraints: []Constraint{{Item: Item{Type: Type{Type: String}}}}}}}}}}}}}}}}},
		{"yaml", []*map[string]interface{}{doc2}, &SSConfig{Databases: []Database{{D_name: "DB", Collection: Collection{C_name: "Coll", Fields: []Field{{F_name: "name", Constraints: []Constraint{{Item: Item{Type: Type{Type: Object, P_ElementType: []interface{}{Field{F_name: "fname", Constraints: []Constraint{{Item: Item{Type: Type{Type: String}}}}}}}}}}}}}}}}},
		{"yaml", []*map[string]interface{}{doc3}, &SSConfig{Databases: []Database{{D_name: "DB", Collection: Collection{C_name: "Coll", Fields: []Field{{F_name: "name", Constraints: []Constraint{{Item: Item{Type: Type{Type: Object, P_ElementType: []interface{}{Field{F_name: "lname", Constraints: []Constraint{{Item: Item{Type: Type{Type: String}}}}}}}}}}}}}}}}},
		{"yaml", []*map[string]interface{}{doc4}, &SSConfig{Databases: []Database{{D_name: "DB", Collection: Collection{C_name: "Coll", Fields: []Field{{F_name: "name", Constraints: []Constraint{{Item: Item{Type: Type{Type: Object, P_ElementType: []interface{}{Field{F_name: "age", Constraints: []Constraint{{Item: Item{Type: Type{Type: Integer}}}}}, Field{F_name: "fname", Constraints: []Constraint{{Item: Item{Type: Type{Type: String}}}}}}}}}}}}}}}}},
		{"yaml", []*map[string]interface{}{doc1, doc2}, &SSConfig{Databases: []Database{{D_name: "DB", Collection: Collection{C_name: "Coll", Fields: []Field{{F_name: "name", Constraints: []Constraint{{Item: Item{Type: Type{Type: Object, P_ElementType: []interface{}{Field{F_name: "fname", Constraints: []Constraint{{Item: Item{Type: Type{Type: String}}}}}}}}}}}}}}}}},
		{"yaml", []*map[string]interface{}{doc1, doc3}, &SSConfig{Databases: []Database{{D_name: "DB", Collection: Collection{C_name: "Coll", Fields: []Field{{F_name: "name", Constraints: []Constraint{{Item: Item{Type: Type{Type: Object, P_ElementType: []interface{}{Field{F_name: "fname", Constraints: []Constraint{{Item: Item{Type: Type{Type: String}}}}}}}}}, {Item: Item{Type: Type{Type: Object, P_ElementType: []interface{}{Field{F_name: "lname", Constraints: []Constraint{{Item: Item{Type: Type{Type: String}}}}}}}}}}}}}}}}},
		{"yaml", []*map[string]interface{}{doc1, doc4}, &SSConfig{Databases: []Database{{D_name: "DB", Collection: Collection{C_name: "Coll", Fields: []Field{{F_name: "name", Constraints: []Constraint{{Item: Item{Type: Type{Type: Object, P_ElementType: []interface{}{Field{F_name: "fname", Constraints: []Constraint{{Item: Item{Type: Type{Type: String}}}}}}}}}, {Item: Item{Type: Type{Type: Object, P_ElementType: []interface{}{Field{F_name: "age", Constraints: []Constraint{{Item: Item{Type: Type{Type: Integer}}}}}, Field{F_name: "fname", Constraints: []Constraint{{Item: Item{Type: Type{Type: String}}}}}}}}}}}}}}}}},
		{"yaml", []*map[string]interface{}{doc2, doc3}, &SSConfig{Databases: []Database{{D_name: "DB", Collection: Collection{C_name: "Coll", Fields: []Field{{F_name: "name", Constraints: []Constraint{{Item: Item{Type: Type{Type: Object, P_ElementType: []interface{}{Field{F_name: "fname", Constraints: []Constraint{{Item: Item{Type: Type{Type: String}}}}}}}}}, {Item: Item{Type: Type{Type: Object, P_ElementType: []interface{}{Field{F_name: "lname", Constraints: []Constraint{{Item: Item{Type: Type{Type: String}}}}}}}}}}}}}}}}},
		{"yaml", []*map[string]interface{}{doc2, doc4}, &SSConfig{Databases: []Database{{D_name: "DB", Collection: Collection{C_name: "Coll", Fields: []Field{{F_name: "name", Constraints: []Constraint{{Item: Item{Type: Type{Type: Object, P_ElementType: []interface{}{Field{F_name: "fname", Constraints: []Constraint{{Item: Item{Type: Type{Type: String}}}}}}}}}, {Item: Item{Type: Type{Type: Object, P_ElementType: []interface{}{Field{F_name: "age", Constraints: []Constraint{{Item: Item{Type: Type{Type: Integer}}}}}, Field{F_name: "fname", Constraints: []Constraint{{Item: Item{Type: Type{Type: String}}}}}}}}}}}}}}}}},
		{"yaml", []*map[string]interface{}{doc3, doc4}, &SSConfig{Databases: []Database{{D_name: "DB", Collection: Collection{C_name: "Coll", Fields: []Field{{F_name: "name", Constraints: []Constraint{{Item: Item{Type: Type{Type: Object, P_ElementType: []interface{}{Field{F_name: "lname", Constraints: []Constraint{{Item: Item{Type: Type{Type: String}}}}}}}}}, {Item: Item{Type: Type{Type: Object, P_ElementType: []interface{}{Field{F_name: "age", Constraints: []Constraint{{Item: Item{Type: Type{Type: Integer}}}}}, Field{F_name: "fname", Constraints: []Constraint{{Item: Item{Type: Type{Type: String}}}}}}}}}}}}}}}}},
	}
